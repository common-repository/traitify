 ...
 * Description: Integrate Traitify in WordPress to examine personality in careers, relationships, media preferences, etc. You can self-discover and decide on the people’s behaviour and attitude.
 * Version: 1.0.1
 * Author: Smackcoders
 * Author URI: http://www.smackcoders.com
 */
/*********************************************************************************
 * Tratify is a Tool to integrate Traitify inside WordPress 
 * plugin developed by Smackcoders. Copyright (C) 2014 Smackcoders.
 *
 * Traitify is free software; you can redistribute it and/or
 * modify it under the terms of the GNU Affero General Public License version 3
 * as published by the Free Software Foundation with the addition of the
 * following permission added to Section 15 as permitted in Section 7(a): FOR
 * ANY PART OF THE COVERED WORK IN WHICH THE COPYRIGHT IS OWNED BY WP Ultimate
 * CSV Importer, Traitify DISCLAIMS THE WARRANTY OF NON
 * INFRINGEMENT OF THIRD PARTY RIGHTS.
 *
 * Traitify is distributed in the hope that it will be useful,
 ...
 * Traitify copyright notice. If the display of the logo is
...
define('WP_TRAITIFY_VERSION', '1.0.1');
