...
Integrate Traitify in WordPress to examine personality in careers, relationships, media preferences, etc. You can self-discover and decide on the people’s behaviour and attitude.

== Description ==
Wordpress Traitify plugin to integrate Traitify's Personality API to your wordpress - Integrate Traitify in WordPress to analyse People’s behaviour and attitude to take better decision.
...
== Changelog ==
= 1.0.1 =
* Modified: Download URL of the library.
* Tested and verified in WordPress 4.6-beta.
...
== Upgrade Notice ==
= 1.0.1 =
Upgrade now to download the library.
